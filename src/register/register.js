                ...
                <div className='row' id='Book_form'>
                    <div className='row' id='Book_form_1'>
                        <div className='col' id='Book_form_box'>
                            <form id='Book_form_tag'>
                                <h1 style={{ color: "white" }}>Register your slot</h1>
                                <div className='col'>
                                    <input type="text" id="Book_name" placeholder="Name" className='field' />
                                </div>
                                <div className='col'>
                                    <input type="text" id="Book_email" placeholder="E Mail" className='field' />
                                </div>
                                <div className='col'>
                                ...
                                <div className="col" id="privacy">
                                    ...
                                    <p>i agree to the <a>terms and conditions</a> and <a>privacy policy</a></p>
