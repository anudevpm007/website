      ...
      <div className=" flex justify-center mt-10">
        <div className="w-[90%]">
          <div className="text-[5vw] md:text-[4vw] lg:text-[3vw]">
            What{" "}
            <span className="text-[#185BD8] font-heading">Our Clients</span> Say
          </div>
          <div className="flex justify-center mt-10">
            <div className="w-[100%] items-center relative flex justify-center">
              <div className=" bg-[#185BD8] p-[20px] py-[15px] w-[92%] rounded-lg">
                ...
                <div className="mt-5 text-[2vw] font-heading text-white w-[100%] flex justify-end p-3">
                  {data2[changeP]}
                </div>
              </div>
        ...
        <div className="flex justify-center absolute md:relative md:bg-[#185BD8] md:py-10 w-full">
          <div className="w-[80%]">
            ...
            <p className="flex justify-center  text-white text-[4.5vw] md:text-[4vw] text-center mt-4">
              Get in Touch to discuss your business challenges and explore our
