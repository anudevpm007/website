      ...
      <div id="bodySec">
        ...
        <div className="flex justify-center py-10">
          <div className="w-[95%] lg:w-[85%]">
            ...
            we believe in the power of diverse talent. We offer a dynamic environment where your skills and creativity can thrive. Join us and make a real impact in cybersecurity, while growing alongside a team that values innovation, collaboration, and your unique contributions.
