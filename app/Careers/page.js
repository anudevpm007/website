    ...
    <div className="relative">
      ...
      <div className="py-36">
        <div className="text-[8vw] font-body flex justify-center">
          JOIN{" "}
          <span className="ml-4  text-[#185BD8] font-heading">OUR TEAM</span>
        </div>
      ...
      <div id="bodySec">
        <div className="flex justify-center items-center flex-col lg:flex-row bg-[#2f80ed] py-16">
          <div className="w-[85%] grid grid-cols-2 gap-9 lg:gap-20">
            <div>
              <div className="flex justify-center">
                <Image
                  src={AimImg}
                  className="w-[90%] md:w-[50%] xl:w-[50%]"
                  alt="N?A"
                />
              </div>
              ...
              <p className="font-body flex justify-center text-[2.4vw] md:text-[1.5vw] lg:text-[1.2vw]  mt-2 text-white text-center">
                We protect businesses from online threats by offering expert
                assessments, innovative solutions, ensuring compliance,
                educating future professionals, identifying vulnerabilities, and
                fostering collaboration to stay ahead of evolving risks.
              </p>
            </div>
            <div>
              <div className="flex justify-center">
        ...
        <div className="flex justify-center py-10">
          <div className="w-[95%] lg:w-[85%]">
            ...
            <p className="font-body mt-8 xl:text-[1.4vw] text-[2.8vw] md:text-[1.8vw] text-[#383838be]">
              we believe in the power of diverse talent. We offer a dynamic
              environment where your skills and creativity can thrive. Join us
              and make a real impact in cybersecurity, while growing alongside a
              team that values innovation, collaboration, and your unique
              contributions.
            </p>
                ...
                <div>
                  <div className="bg-[#185BD8] rounded-md p-[2px] xl:my-5 my-3 xl:mb-8 mb-4 w-fit">
                    <Image
                      src={IMG1}
                      alt="N?A"
                      className="sm:w-[6vw] w-[8vw] md:w-[5vw] lg:w-[4vw] xl:lg:w-[3vw]"
                    />
                  </div>
                </div>
        ...
        <div className="flex justify-center py-10">
          <div className="w-[95%] xl:w-[85%]">
            <div className=" font-body text-[5vw] md:text-[4vw] xl:text-[3vw] font-light">
              Open Positions
            </div>
        ...
        <div className="flex mt-7 justify-center">
          <div className="bg-[#185BD8] py-6 rounded-md    w-[95%]  md:w-[85%] relative">
            ...
            <div className="md:absolute w-full top-[25%] justify-center flex flex-col items-center">
              <h1 className="font-headingSemiBold text-[7vw] md:text-[3vw] text-white">
                Join our Community
              </h1>
              <p className="font-body text-[2.6vw] md:text-[1.6vw] text-white">
                Register today & start exploring the endless possibilities.
              </p>
              <Link
                href={"https://whatsapp.com"}
                className="font-body  md:text-[1.5vw] text-[4vw] px-16 mt-5 rounded-md py-1 md:py-2 bg-white text-black"
              >
                Join
              </Link>
            </div>
        ...
        <div className="flex justify-center text-center text-[7vw] font-bold text-[#185BD8] leading-none mt-20 mb-8 md:mb-0 font-headingHeavy">
          BUILD THE FUTURE,
          <br />
          TOGETHER
        </div>
