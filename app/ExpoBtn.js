...
export default function () {
    return (
        <div className="flex justify-center mt-10">
            ...
            <Link className="bg-[#185BD8] hover:font-headingSemiBold duration-100 active:py-2 py-4 px-6 rounded-lg font-body text-white" href={"/Registration"} >Explore Solutions</Link>
        </div>
    )
}
