...
export default async function page({ searchParams }) {
    ...
    try {
        ...
        if (
          indexValue.id !== undefined ||
          indexValue.id !== null ||
          indexValue.id.length !== 0
        ) {
          if (
            indexValue.i !== undefined ||
            indexValue.i !== null ||
            indexValue.i.length !== 0
          ) {
            ref = 1;
            id = indexValue?.id;
            i = indexValue?.i;
          ...
          if(i== undefined||null && id === undefined||null){
            ref = 0;
          }
        } else {
          console.log("wrong");
    ...
    const Heading1 = () => {
      if (id < 3) {
        return (
          <span className="text-[#185BD8] font-heading">
            {dbServices[id].content[i].heading}
          </span>
        );
      }
    };
        ...
        <div>
          ...
          <div id="bodySec">
            ...
            <div className=" mt-5 flex xl:hidden justify-center relative ">
              ...
              <div className="flex justify-center absolute md:relative md:bg-[#185BD8] md:py-10 w-full">
                <div className="w-[80%]">
                  ...
                  <h1 className="flex justify-center font-heading text-white text-[6.4vw] md:text-[6vw]">
                    Take the Next Step.{" "}
                  </h1>
                  <p className="flex justify-center  text-white text-[4.5vw] md:text-[4vw] text-center mt-4">
                    Get in Touch to discuss your business challenges and explore
            ...
            <div className="hidden xl:flex justify-center relative py-4 bg-transparent mt-28">
              <Image
                className="absolute h-full w-full object-fill -z-10"
                src={EventBg}
                alt="N?A"
              />
              ...
              <div className="flex justify-center bg-[#F1F5F7]">
                <div className="md:w-[85%] w-[95%] ">
                  <div className="text-[3.5vw] md:text-[3vw] lg:text-[2.5vw] mt-10 mb-20 font-body">
                    Why Choose
                    <span className="font-heading text-[#185BD8]">
                      {" "}
                      Astraliva
                    </span>{" "}
                    for Your services Security
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5 xl:gap-8 mt-10 mb-16">
                    ...
                    <div className="md:px-10 px-3 md:py-8 lg:py-10 py-6 rounded-xl border-[#BBBBBB] border-[0.5px] shadow-[5px_6px_5px_1px_rgba(0,0,0,0.18)]">
                      ...
                      <div className="w-[30%] h-1 bg-[#185BD8] mt-5 mb-5"></div>
                      <p className="font-body text-[3vw] md:text-[2vw] lg:text-[1.4vw] mt-8">
                        Comprehensive testing using both manual and automated
                        methods.
                      </p>
                    </div>
                    <div className="md:px-10 px-3 md:py-8 lg:py-10 py-6 rounded-xl border-[#BBBBBB] border-[0.5px] shadow-[5px_6px_5px_1px_rgba(0,0,0,0.18)]">
                    ...
                    <div className="md:px-10 px-3 md:py-8 lg:py-10 py-6 rounded-xl border-[#BBBBBB] border-[0.5px] shadow-[5px_6px_5px_1px_rgba(0,0,0,0.18)]">
                      ...
                      <div className="w-[30%] h-1 bg-[#185BD8] mt-5 mb-5"></div>
                      <p className="font-body text-[3vw] md:text-[2vw] lg:text-[1.4vw] mt-8">
                        Help with meeting security standards and certifications
                        like PCI-DSS, GDPR, and ISO 27001.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-center">
                  <div className="md:w-[95%] w-[100%]">
                    {QAdb[id].map((data, index) => {
                      return <QA Q={data.Q} A={data.A} key={data.id} />;
                    })}
                  </div>
                </div>
              </div>
